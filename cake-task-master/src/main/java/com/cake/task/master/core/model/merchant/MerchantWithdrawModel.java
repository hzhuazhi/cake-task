package com.cake.task.master.core.model.merchant;
...
/**
 * @Description 卡商的提现记录的实体属性Bean
 * @Author yoko
 * @Date 2021/1/11 11:17
 * @Version 1.0
 */
public class MerchantWithdrawModel extends BasePage implements Serializable {
