package com.cake.task.master.core.model.monitor;
...
/**
 * @Description 监控银行卡的实体属性Bean
 * @Author yoko
 * @Date 2020/12/29 15:09
 * @Version 1.0
 */
public class MonitorBankModel extends BasePage implements Serializable {
    private static final long   serialVersionUID = 1203229201132L;
    ...
    public Integer getNotSucNum() {
        return notSucNum;
    }

    public void setNotSucNum(Integer notSucNum) {
        this.notSucNum = notSucNum;
    }
